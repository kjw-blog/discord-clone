                            ...
                            <FormControl>
                                <div className="relative p-4 pb-6">
                                    <button
                                        ...
                                        className="absolute left-8 top-7 flex h-[24px] w-[24px] items-center justify-center rounded-full bg-zinc-500 transition hover:bg-zinc-600 dark:bg-zinc-400 dark:hover:bg-zinc-300"
                                    >
